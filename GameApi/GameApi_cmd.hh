...
MACRO2(GameApi::FI,ev.font_api.load_font("https://meshpage.org/assets/Chunkfive.otf",20,20))
...
MACRO2(GameApi::FS,ev.float_scene_api.fs_sphere(0.0,0.0,0.0,300.0))
#undef MACRO2
...
class EnvGameApiItem_int : public GameApiItem
{
public:
  EnvGameApiItem_int() { }
  virtual int Count() const { return 1; }
  virtual std::string Name(int i) const { return "env_params_int"; }
  ...
  virtual std::string FuncName(int i) const { return "identity_int"; }
...
class EnvGameApiItem_string : public GameApiItem
{
public:
  EnvGameApiItem_string() { }
  virtual int Count() const { return 1; }
  virtual std::string Name(int i) const { return "env_params_string"; }
  virtual int ParamCount(int i) const { return 1+5; }
  virtual std::string ParamName(int i, int p) const {
    switch(p) {
    case 0: return "ml";
  ...
  virtual std::string ReturnType(int i) const { return "ML"; }
  virtual std::string ApiName(int i) const { return "mainloop_api"; }
  virtual std::string FuncName(int i) const { return "identity_string"; }
  virtual std::string Symbols() const { return ""; }
  virtual std::string Comment() const { return "env setup"; }
  virtual int Execute(std::stringstream &ss, GameApi::Env &ee, GameApi::EveryApi &ev, std::vector<std::string> params, GameApi::ExecuteEnv &e, int j)
  {
...
class EnvGameApiItem_float : public GameApiItem
{
public:
  EnvGameApiItem_float() { }
  virtual int Count() const { return 1; }
  virtual std::string Name(int i) const { return "env_params_float"; }
  virtual int ParamCount(int i) const { return 1+5; }
  virtual std::string ParamName(int i, int p) const {
    switch(p) {
    case 0: return "ml";
  ...
  virtual std::string ReturnType(int i) const { return "ML"; }
  virtual std::string ApiName(int i) const { return "mainloop_api"; }
  virtual std::string FuncName(int i) const { return "identity_float"; }
  virtual std::string Symbols() const { return ""; }
  virtual std::string Comment() const { return "env setup"; }
  virtual int Execute(std::stringstream &ss, GameApi::Env &ee, GameApi::EveryApi &ev, std::vector<std::string> params, GameApi::ExecuteEnv &e, int j)
  {
