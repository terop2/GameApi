...
std::vector<GameApiItem*> polygonapi_functions1()
{
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::voxel_api, &GameApi::VoxelApi::vox_voxel,
			 "p_vox",
			 { "ev", "url" , "model", "sx", "sy", "sz", "level" },
			 { "EveryApi&", "std::string", "int", "float", "float", "float", "int" },
			 { "ev", "https://meshpage.org/assets/test.vox", "0", "20.0", "20.0", "20.0", "0" },
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::polygon_api, &GameApi::PolygonApi::p_array,
                        "p_array2",
			 { "vec" },
                        { "[P]" },
                        { "" },
                        "PV", "polygon_api", "p_array"));
  vec.push_back(ApiItemF(&GameApi::EveryApi::polygon_api, &GameApi::PolygonApi::seq_p_array,
                        "seq_p_array",
			 { "vec", "vec2" },
                        { "[P]", "[P]" },
                        { "", "" },
                        "[P]", "polygon_api", "seq_p_array"));
  vec.push_back(ApiItemF(&GameApi::EveryApi::polygon_api, &GameApi::PolygonApi::array_p_array,
                        "array_p_array",
                        { "vec" },
                        { "[PV]" },
                        { "" },
                   "[P]", "polygon_api", "array_p_array"));
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::polygon_api, &GameApi::PolygonApi::spatial_decimate,
			 ...
			 { "P", "float" },
			 { "", "0.5" },
			 "P", "polygon_api", "spatial_decimate"));
#endif
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::gltf_mesh_all_p_arr,
			 "gltf_mesh_all_p_arr",
			 { "ev", "model", "light_dir_x", "light_dir_y", "light_dir_z", "is_transparent", "emissive", "lod_level" },
			 { "EveryApi&", "TF", "float", "float", "float","bool", "bool", "int" },
			 { "ev", "", "1.0", "1.0", "1.0","true","true","-1" },
