...
std::vector<GameApiItem*> blocker_functions(GameApi::EveryApi &ev)
{
  ...
  */
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::web_link,
			 "web_link",
			 { "ev", "item", "highlighted_item", "pt_x", "pt_y", "pt_z", "radius", "web_link" },
...
#endif
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::current_time,
			 "t_curr_time",
			 { "prev" },
			 { "TT" },
			 { "" },
			 "TT", "mainloop_api", "current_time"));
#if (ALL==1)||(TIMING==1)
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::array_timing_chain,
			 "t_chain",
			 { "prev", "start_time", "durations", "vec" },
			 { "TT", "float", "std::string", "[ML]" },
			 { "", "0.0", "2&2&2", "" },
			 "TT", "mainloop_api", "array_timing_chain"));
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::array_timing_chain_ml,
			 "t_chain_ml",
			 { "start_time", "durations", "vec", "repeat" },
			 { "float", "std::string", "[ML]", "int" },
			 { "0.0", "2&2&2", "", "1" },
  ...
  */
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::gltf_scene,
			 "ml_gltf_scene",
			 { "ev", "tf", "scene_id", "keys","mix","self_mult", "rest_mult","mode","light_dir_x", "light_dir_y", "light_dir_z", "animation","border_width", "border_color","is_transparent", "acesfilm", "emissive", "frame_skip", "lod_level" },
			 { "EveryApi&", "TF", "int", "std::string","float","float", "float","int", "float", "float", "float", "int", "float", "unsigned int","bool", "bool", "bool", "int", "int" },
			 { "ev", "", "0", "cvbnmfghjklertyuiop","1.0","3.0", "1.0","0", "400.0", "-400.0", "300.0", "0", "0.0", "ff000000","true", "true", "true", "1", "-1" },
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::gltf_mesh_all,
			 "ml_gltf_all",
			 { "ev", "tf", "mix", "self_mult", "rest_mult", "mode", "light_dir_x", "light_dir_y", "light_dir_z", "border_width", "border_color", "transparent", "acesfilm", "emissive", "lod_level" },
			 { "EveryApi&", "TF", "float", "float", "float", "int", "float", "float", "float", "float", "unsigned int", "bool", "bool","bool", "int" },
			 { "ev", "", "1.0","3.0", "0.0", "0", "400.0", "-400.0", "300.0", "0.0", "ff000000","true", "true", "true", "-1" },
			 "ML", "mainloop_api", "gltf_mesh_all"));
#endif
#if (ALL==1)||(GLTF_MESH_ALL_INST2==1)
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::gltf_mesh_all_inst2,
			 "ml_gltf_all_inst",
			 { "ev", "tf", "resize_obj", "pts", "mix", "self_mult", "rest_mult", "mode", "light_dir_x", "light_dir_y", "light_dir_z", "border_width", "border_color", "transparent", "acesfilm", "keys","emissive", "lod_level" },
			 { "EveryApi&", "TF", "TF", "PTS", "float", "float", "float", "int", "float", "float", "float", "float", "unsigned int", "bool", "bool", "std::string", "bool", "int" },
			 { "ev", "", "", "", "1.0","3.0", "0.0", "0", "400.0", "-400.0", "300.0", "0.0", "ff000000","true", "true", "c", "true", "-1" },
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::gltf_mesh_all_inst_matrix,
			 "ml_gltf_all_inst_m",
			 { "ev", "tf", "resize_obj", "ms", "mix", "self_mult", "rest_mult", "mode", "light_dir_x", "light_dir_y", "light_dir_z", "border_width", "border_color", "transparent", "acesfilm", "keys", "emissive", "lod_level" },
			 { "EveryApi&", "TF", "TF", "MS", "float", "float", "float", "int", "float", "float", "float", "float", "unsigned int", "bool", "bool", "std::string", "bool", "int" },
			 { "ev", "", "", "", "1.0","3.0", "0.0", "0", "400.0", "-400.0", "300.0", "0.0", "ff000000","true", "true", "c", "true", "-1" },
			 "ML", "mainloop_api", "gltf_mesh_all_inst_matrix"));
#endif
  
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::transfer_id,
			 "transfer_id",
			 { },
			 { },
			 { },
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::gltf_mesh_all_anim,
			 "ml_gltf_all_anim",
			 { "ev", "tf","mix","self_mult", "rest_mult", "mode", "keys", "light_dir_x", "light_dir_y", "light_dir_z", "border_width", "border_color","transparent", "acesfilm", "start_anim_seq","emissive", "frame_skip", "lod_level" },
			 { "EveryApi&", "TF","float","float", "float","int","std::string", "float", "float", "float", "float", "unsigned int","bool", "bool", "int", "bool", "int", "int" },
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::gltf_scene_anim,
			 "ml_gltf_sc_anim",
			 { "ev", "tf", "scene_id", "animation", "keys","mix","self_mult", "rest_mult","mode", "light_dir_x", "light_dir_y", "light_dir_z","border_width", "border_color" , "transparent", "acesfilm", "emissive", "frame_skip", "lod_level" },
			 { "EveryApi&", "TF", "int", "int", "std::string","float","float", "float", "int", "float", "float", "float", "float", "unsigned int","bool", "bool", "bool", "int", "int" },
			 { "ev", "", "0", "0", "cvbnmfghjklertyuiop","1.0","3.0", "1.0","0", "400.0", "-400.0", "300.0", "0.0", "ff000000","true", "true", "true", "1", "-1" },
...
vec.push_back(ApiItemF(&GameApi::EveryApi::polygon_api, &GameApi::PolygonApi::mesh_anim_display_inst,
 ...
 vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::lod_pts_tf,
			"m_lod_pts_tf",
			{ "ev", "tf", "pts", "decimate_level1", "decimate_level2", "decimate_level3", "decimate_level4", "max_obj_count1", "max_obj_count2", "max_obj_count3", "max_obj_count4", "mix", "self_mult", "rest_mult", "mode", "light_dir_x", "light_dir_y", "light_dir_z", "border_width", "border_color", "transparent", "acesfilm", "start_brighness", "end_brightness","emissive" },
			{ "EveryApi&", "TF", "PTS", "float", "float","float", "float", "int", "int", "int", "int", "float", "float", "float", "int", "float", "float", "float", "float", "unsigned int", "bool", "bool", "float", "float","bool" },
			{ "ev", "", "", "0.8", "0.6","0.4", "0.2", "45", "45", "95", "120", "1.0", "3.0", "1.0", "0", "0.1", "0.1", "-400.0", "0", "ff000000", "false", "true", "1.0", "0.3", "true" },
 ...
 vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::lod_matrix_tf,
			"m_lod_matrix_tf",
			{ "ev", "tf", "ms", "decimate_level1", "decimate_level2", "decimate_level3", "decimate_level4", "max_obj_count1", "max_obj_count2", "max_obj_count3", "max_obj_count4", "mix", "self_mult", "rest_mult", "mode", "light_dir_x", "light_dir_y", "light_dir_z", "border_width", "border_color", "transparent", "acesfilm", "start_brightness", "end_brightness", "emissive" },
			{ "EveryApi&", "TF", "MS", "float", "float","float", "float", "int", "int", "int", "int", "float", "float", "float", "int", "float", "float", "float", "float", "unsigned int", "bool", "bool", "float", "float","bool" },
			{ "ev", "", "", "0.8", "0.6","0.4", "0.2", "45", "45", "95", "120", "1.0", "3.0", "1.0", "0", "0.1", "0.1", "-400.0", "0", "ff000000", "false", "true", "1.0", "0.3", "true" },
 ...
 vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::lod_anim,
			"m_lod_anim",
			{ "ev", "tf", "pts", "level1", "level2", "level3", "level4", "l1", "l2", "l3", "l4", "mix", "self_mult", "rest_mult", "mode", "keys", "light_dir_x", "light_dir_y", "light_dir_z", "border_width", "border_color", "transparent", "acesfilm", "start_anim_seq","emissive", "frame_skip" },
			{ "EveryApi&", "TF", "PTS", "float", "float", "float", "float", "int", "int", "int", "int", "float", "float", "float", "int", "std::string", "float", "float", "float", "float", "unsigned int", "bool", "bool", "int","bool", "int" },
			{ "ev", "", "", "0.8", "0.6", "0.4", "0.2", "45", "45", "45", "45", "1.0", "3.0", "0.0", "0", "cvb", "0.1", "400.0", "0.1", "0.0", "ff000000", "false", "true", "0","true", "1" },
			"ML", "mainloop_api", "lod_anim"));

 vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::lod_anim_matrix,
			"m_lod_anim_matrix",
			{ "ev", "tf", "ms", "level1", "level2", "level3", "level4", "l1", "l2", "l3", "l4", "mix", "self_mult", "rest_mult", "mode", "keys", "light_dir_x", "light_dir_y", "light_dir_z", "border_width", "border_color", "transparent", "acesfilm", "start_anim_seq", "emissive","frame_skip" },
			{ "EveryApi&", "TF", "MS", "float", "float", "float", "float", "int", "int", "int", "int", "float", "float", "float", "int", "std::string", "float", "float", "float", "float", "unsigned int", "bool", "bool", "int","bool", "int" },
			{ "ev", "", "", "0.8", "0.6", "0.4", "0.2", "45", "45", "45", "45", "1.0", "3.0", "0.0", "0", "cvb", "0.1", "400.0", "0.1", "0.0", "ff000000", "false", "true", "0", "true", "1" },
...
vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::print_deps,
 ...
 vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::key_press_print_time_sync,
			"key_print_time_sync",
			{ "ml" },
			{ "ML" },
			{ "" },
			"ML", "mainloop_api", "key_press_print_time_sync"));
...
vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::memmap_window2,
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::glb_to_download_bar,
			 "download_glb",
			 { "tf", "filename" },
			 { "TF", "std::string" },
			 { "", "output.glb" },
