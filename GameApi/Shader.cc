...
void Program::link()
{
  ...
  int len=0;
  char log[255];
    glGetProgramInfoLog(priv->program, 256, &len, &log[0]);
...
"#ifdef EX_TEXCOORD\n"
"#ifdef COLOR_MIX\n"
"vec4 textureimpl(vec4 rgb)\n"
"{\n"
"   return mix(rgb, texture(tex, ex_TexCoord.xy), color_mix);\n"
"}\n"
"#endif\n"
"#endif\n"
"#ifdef EX_TEXCOORD\n"
...
"void main(void)\n"
"{\n"
"   gl_FragColor = texture(tex, ex_TexCoord.xy);\n"
  "}\n";
#else
  std::string s =
"//V: comb\n"
...
"void main(void)\n"
"{\n"
"   out_Color = texture(texture, ex_TexCoord.xy);\n"
  "}\n";
#endif
