...
"float intensity(vec3 N) {\n"
  " vec3 H = normalize(ex_LightPos2)+vec3(0.0,0.0,-1.0);\n"
  " vec3 H2 = normalize(H);\n"
    " float val = max(dot(-N,H2),0.0);\n"
    " return val;\n"
    "}\n"
...
"float intensitya(vec3 N) {\n"
  " vec3 H = normalize(ex_LightPos2)+vec3(0,0,-1);\n"
  " vec3 H2 = normalize(H);\n"
