...
#endif
    "mrSample2.b *= u_DiffFactor.r;\n"
    "mrSample2.g *= u_DiffFactor.g;\n"
    "mrSample2.r *= u_DiffFactor.b;\n"
   " diffuseColor = mrSample2.bgr * (1.0-max(max(baseColor.r,baseColor.g),baseColor.b));\n"
   " f0 = baseColor.bgr;\n"
   "f0.r *= u_SpecFactor.b;\n"
   "f0.g *= u_SpecFactor.g;\n"
   "f0.b *= u_SpecFactor.r;\n"
...
"#ifdef GLTF_TEX1\n"
   ...
   " diffuseColor = mrSample2.bgr * (1.0-max(baseColor.r,baseColor.g,baseColor.b));\n"
   " f0 = baseColor.bgr;\n"
   "f0.r *= u_SpecFactor.b;\n"
   "f0.g *= u_SpecFactor.g;\n"
   "f0.b *= u_SpecFactor.r;\n"
