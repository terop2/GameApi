...
" return clamp(max(0,dot(dir,ex_LightPos2)),0.0,1.0);\n"
"}\n"
...
" return 1.0-min(1,dot(dir,ex_LightPos2));\n"
"}\n"
...
"vec3 normalmix(vec3 a, vec3 b) {\n"
    ...
    "return vec3(sin(angle1)*cos(angle2),sin(angle1)*sin(angle2),cos(angle1));\n"
    //"return normalize(normalize(a)+normalize(b)*0.1);\n"
"}\n"
...
"#ifdef EX_POSITION\n"
    ...
    "d=1.0-d;\n"
           "d=clamp(d,0.0,1.0);\n"
           "d=d*d;\n"
    //"d=d*dot(ex_Normal2,normalize(p));\n"
           "d=clamp(d,0.0,1.0);\n"
...
"uniform float hilight;\n"	  
"float intensity(vec3 dir) {\n"
" return max(0,dot(dir,ex_LightPos2));\n"
"}\n"
"float intensity2(vec3 dir) {\n"
" float i=intensity(dir); return pow(i,hilight);\n"
"}\n"
...
"vec4 dyn_lights(vec4 rgb)\n"
    ...
    "d=1.0-d;\n"
           "d=clamp(d,0.0,1.0);\n"
           "d=d*d;\n"
    //"d=d+d*dot(ex_Normal2,normalize(p));\n"
           "d=clamp(d,0.0,1.0);\n"
