...
"    float theta = clamp( dot( normal_cam, light_dir_cam ), 0.0,1.0) ;\n"
...
"    p2 = 1.0-p2;\n"
"    return rgb + level3_color * p2 * length(rgb);\n"
"}\n"
"#endif\n"
"#endif\n"
"#endif\n"
...
"  return mix(rgb, texture2D(texsampler[0],ex_TexCoord.xy), color_mix);\n"
...
"  if (ex_TexCoord.z<17.7)\n"
"  return mix(rgb, texture2D(texsampler[17],ex_TexCoord.xy), color_mix);\n"
"  if (ex_TexCoord.z<18.7)\n"
"  return mix(rgb, texture2D(texsampler[18],ex_TexCoord.xy), color_mix);\n"
"  if (ex_TexCoord.z<19.7)\n"
"  return mix(rgb, texture2D(texsampler[19],ex_TexCoord.xy), color_mix);\n"
"}\n"
"#endif\n"
"#endif\n"
"#ifdef EX_TEXCOORD\n"
...
"vec4 manytextures(vec4 rgb)\n"
"{\n"
"  return mix(rgb, texture2D(texsampler[int(ex_TexCoord.z)],ex_TexCoord.xy), color_mix);\n"
"}\n"
"#endif\n"
"#endif\n"
"#ifdef EX_TEXCOORD\n"
