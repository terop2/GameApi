...
std::vector<GameApiItem*> fontapi_functions()
{
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::mainloop_api, &GameApi::MainLoopApi::game,
			 ...
			 { "ev", "64", "64", "https://tpgames.org/test.map", "https://tpgames.org/anim.map", "https://tpgames.org/items.map", "https://tpgames.org/enemy.map", "abcde--------ghi", "-----abcdefghijklmno", "10", "10", "24", "33", "", "","","","", "", "", "", "", "","","","","" },
