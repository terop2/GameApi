...
static unsigned char cursor_1_data[32*4] = {
 // Top tab (first 8 rows)
    0x00,0x00,0x00,0x00,
    0x00,0xFF,0xFF,0x00,
    0x00,0xFF,0xFF,0x00,
    0x00,0xFF,0xFF,0x00,
...
static unsigned char cursor_1_mask[64*8] = {
    // All visible pixels same as before
    0xFF,0xFF,0xFF,0xFF,
    0xFF,0xFF,0xFF,0xFF,
    0xFF,0xFF,0xFF,0xFF,
    0xFF,0xFF,0xFF,0xFF,
 ...
 cursor0 = g_low->sdl->SDL_CreateCursor(cursor_0_data,cursor_0_mask,8,16,0,0);
  cursor1 = g_low->sdl->SDL_CreateCursor(cursor_1_data,cursor_1_mask,8*4,32,0,0);
