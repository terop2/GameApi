...
type %TEMP%\_gameapi_builder\gameapi_0.html %TEMP%\_gameapi_builder\gameapi_homepage.html %TEMP%\_gameapi_builder\gameapi_1.html %TEMP%\_gameapi_builder\gameapi_script.html %TEMP%\_gameapi_builder\gameapi_2.html %TEMP%\_gameapi_builder\gameapi_date.html %TEMP%\_gameapi_builder\gameapi_3.html >%TEMP%\_gameapi_builder\deploy\gameapi_index.php
cd ..
