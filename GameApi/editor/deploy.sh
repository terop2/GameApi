...
if [[ $1 ]]; then
    ...
    if [[ "$2" == "seamless" ]]; then
	cat $HOME/.gameapi_builder/gameapi_0_seamless.html $HOME/.gameapi_builder/gameapi_homepage.html $HOME/.gameapi_builder/gameapi_1.html $HOME/.gameapi_builder/gameapi_script.html $HOME/.gameapi_builder/gameapi_2.html $HOME/.gameapi_builder/gameapi_date.html $HOME/.gameapi_builder/gameapi_3_seamless.html >$HOME/.gameapi_builder/deploy/display.php
    else
