...
if [[ $1 ]]; then
    ...
    cat ~/.gameapi_builder/gameapi_0.html ~/.gameapi_builder/gameapi_homepage.html ~/.gameapi_builder/gameapi_1.html ~/.gameapi_builder/gameapi_script.html ~/.gameapi_builder/gameapi_2.html ~/.gameapi_builder/gameapi_date.html ~/.gameapi_builder/gameapi_3.html >~/.gameapi_builder/deploy/gameapi_index.html
