...
class OpenglEGL : public OpenglLowApi
{
public:
  virtual void init() { }
  virtual void cleanup() { }

  virtual int glGetError() { return 0 /*::glGetError();*/; }
...
class OpenVRLowApiEGL : public OpenVRLowApi
{
  virtual void init() { }
  virtual void cleanup() { }
};

class EmscriptenLowApiEGL : public EmscriptenLowApi
{
public:
  virtual void init() { }
  virtual void cleanup() { }
...
class EmscriptenVRLowApiEGL : public EmscriptenVRLowApi
{
  virtual void init() { }
  virtual void cleanup() { }
...
class FileSystemLowApiEGL : public FileSystemLowApi
{
  virtual void init() { }
  virtual void cleanup() { }
...
class ImageLoadLowApiEGL : public ImageLoadLowApi
{
  virtual void init() { }
  virtual void cleanup() { }
...
class SDLImageLowApiEGL : public SDLImageLowApi
{
  virtual void init() { }
  virtual void cleanup() { }
};
...
void initialize_egl(int flags)
{
  LowApi *low = new LowApi;
  low->ogl = new OpenglEGL;
  low->sdl = new SDLLowApiEGL;
