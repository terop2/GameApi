...
echo "<meta http-equiv=\"Cache-Control\" content=\"no-cache, no-store, must-revalidate, max-age=0\" />";
echo "<meta http-equiv=\"Pragma\" content=\"no-cache\" />";
echo "<meta http-equiv=\"Expires\" content=\"Tue, 01 Jan 2000 00:00:00 GMT\" />";
...
echo "<div class=\"bl_column\">\n";
echo "<div class=\"bl_item customfont content\">\n";
echo "<h2><span class=\"large\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;14</span> years of work,<br><span class=\"large\">&nbsp;&nbsp;&nbsp;260</span> kloc of source code,<br> <span class=\"large\">&nbsp;&nbsp;870</span> builder tool nodes,<br><span class=\"large\">2900</span> version control commits,<br>   <span class=\"large\">3700</span> page views,<br><span class=\"large\">&nbsp;&nbsp;600</span> downloads</h2>\n";
echo "</div>\n";
echo "</div>\n";
echo "</div>\n";
...
echo "<li><b>Concurrent network stack</b> starting web downloads early\n";
echo "<li><b>8 CPUs used for</b> zip decode,image decode,vertex arrays,textures after web deploy\n";
...
echo "<li>Apparently the engine doesn't work in samsung's browser under android/we got jams which have not been investigated.\n";
echo "</ul>\n";
echo "</div>\n";
echo "</div>\n";
