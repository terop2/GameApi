...
echo "<li>Concurrent network stack,zip decode,image decode,vertex arrays,textures using 8 cpus";
...
echo "<li>popularity(access to popular sales platforms missing)";
echo "</ul>";
echo "</div>";
