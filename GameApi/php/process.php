...
echo "</div>";
echo "<div class=\"bl_item content\">";
echo "<br>Features still in the future:";
echo "<ul>";
...
echo "</div><div class=\"bl_item content\">";
...
echo "        \"img content content\"";
echo "        \"content content img\"";
echo "        \"img content content\"";
echo "        \"content content img\"";
echo "        \"img content content\"";
echo "        \"content content img\"";
echo "        \"img content content\";";
echo "   grid-template-columns: autp auto auto;";
echo "   gap: 50px 50px;";
echo "}";
echo ".bl_container > div.img {";
echo "   grid-area: img;";
echo "}";
echo ".bl_container > div.content {";
echo "   grid-area: content;";
echo "}";
echo ".bl_item {";
