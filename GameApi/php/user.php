...
if ("$machine"=="raspberrypi"||"$machine"=="meshpage.ddns.net") {
   ...
   //$site = "192.168.1.104";
   //$assetsite = "192.168.1.104/assets";
   //$sitename = "192.168.1.104";
   $siteprefix=$_SERVER['HTTP_HOST'];
   $siteprefix=substr($siteprefix,0,4);
   //echo "SITEPREFIX: $siteprefix";
   if ("$siteprefix"!="ssh.") $siteprefix="";
...
function small_page_header_body( $arr2, $num )
{
  ...
  analytics();
  $id = create_id( $arr2 );
  echo "<div itemscope itemtype=\"https://schema.org/BreadcrumbList\" id=\"navbar\" class=\"navi navbar navbar-expand-lg navbar-dark bg-dark fixed-top\">";
  echo "<div class=\"ncenter container-fluid\">";
  highlight_start($num, 0,1);
  echo "<a itemprop=\"item\" class=\"navi navbar-brand\" href=\"mesh_all\"><span itemprop=\"name\">" . $sitename . "</span></a>";
  highlight_end($num,0);
  highlight_start($num, 1,1);
  echo "<a itemprop=\"item\" class=\"navi navbar-toggler\" href=\"mesh_display?id=" . $id . "\"><span itemprop=\"name\">mesh display</span></a>";
  highlight_end($num,1);
  highlight_start($num, 2,2);
  echo "<a itemprop=\"item\" class=\"navi navbar-toggler\" href=\"mesh_code?id=" . $id . "\"><span itemprop=\"name\">functions</span></a>";
  highlight_end($num,2);
  highlight_start($num, 3,2);
  echo "<a itemprop=\"item\" class=\"navi navbar-toggler\" href=\"mesh_api?id=" . $id . "\"><span itemprop=\"name\">source code</span></a>";
  highlight_end($num,3);
  highlight_start($num, 4,2);
  echo "<a itemprop=\"item\" class=\"navi navbar-toggler right ms-auto\" href=\"mesh_html?id=" . $id . "\"><span itemprop=\"name\">html embed</span></a>";
  highlight_end($num,4);
  echo "</div>";  
  echo "</div>"; 
...
function page_header( $pos )
{
  ...
  global $site;
   ...
   echo "<a itemprop=\"item\" class=\"navi navbar-toggler\" href=\"create_mesh\"><span itemprop=\"name\">create mesh</span></a>";
   highlight_end($pos, 1);

   //echo " | ";
   highlight_start($pos, 2,2);
   echo "<a itemprop=\"item\"  class=\"navi navbar-toggler\" href=\"mesh_tool\"><span itemprop=\"name\">tool download</span></a>";
   highlight_end($pos, 2);

   //echo " | ";
   highlight_start($pos, 3,2);
   echo "<a itemprop=\"item\" class=\"navi navbar-toggler\" href=\"mesh_faq\"><span itemprop=\"name\">faq</span></a>";
   highlight_end($pos,3);
   //echo " | ";
   highlight_start($pos, 4,2);
   echo "<a itemprop=\"item\" class=\"navi navbar-toggler\" href=\"mesh_tutorial\"><span itemprop=\"name\">docs</span></a>";
   highlight_end($pos, 4);
   //echo " | ";
   highlight_start($pos, 5,2);
   echo "<a itemprop=\"item\" class=\"navi navbar-toggler\" href=\"mesh_about\"><span itemprop=\"name\">about</span></a>";
   highlight_end($pos, 5);
   ...
   echo "<a itemprop=\"item\" class=\"navi right navbar-toggler ms-auto\" href=\"mesh_hide.php\"><span itemprop=\"name\">vault</span></a>";
   highlight_end($pos,6);
   //echo " | ";
   highlight_start($pos,8,2);
   echo "<a itemprop=\"item\" class=\"navi right navbar-toggler ms-auto\" href=\"mesh_block\"><span itemprop=\"name\">block</span></a>";
   highlight_end($pos,8);  

   highlight_start($pos,9,2);
   echo "<a itemprop=\"item\" class=\"navi right navbar-toggler ms-auto\" href=\"mesh_stats\"><span itemprop=\"name\">stats</span></a>";
   highlight_end($pos,9);  

   //echo " | ";
   highlight_start($pos,10,2);
   echo "<a itemprop=\"item\" class=\"navi right navbar-toggler ms-auto\" href=\"mesh_logout\"><span itemprop=\"name\">logout</span></a>";
   highlight_end($pos,10);
   } else {
   //echo " | ";
   highlight_start($pos, 7,1);
   if ($_SERVER["HTTP_HOST"]=="localhost") {
   echo "<a itemprop=\"item\" class=\"navi right navbar-toggler ms-auto\" href=\"https://localhost/mesh-page/mesh_login_page\"><span itemprop=\"name\">login</span></a>";
   } else {
   echo "<a itemprop=\"item\" class=\"navi right navbar-toggler ms-auto\" href=\"" . $site . "/mesh_login_page\"><span itemprop=\"name\">login</span></a>";
   }
   highlight_end($pos,7);
   }
