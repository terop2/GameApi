					     ...
					     Quake_data &data, float &speed_x, float &speed_y, float speed, float rot_speed)
{
  ...
  if ((e.type==1026||e.type==1793) && e.button==-1) data.backward=false;
  ...
  if ((e.type==1026||e.type==1793) && e.button==-1) data.right=false;
  ...
  if ((e.type==1026||e.type==1793) && e.button==-1) data.side_left=false;
  ...
  if ((e.type==1026||e.type==1793) && e.button==-1) data.side_right=false;
