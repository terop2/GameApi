...
public:
  ...
  GameApi::PinIn prepare_instanced(int id, Point *positions, Vector *normals, unsigned int *colors, int size, int colour_divisor);
  GameApi::PinIn prepare_instanced_matrix(int id, Matrix *positions, Vector *normals, unsigned int *colors, int size, int colour_divisor);
  ...
  GameApi::PinIn render_instanced(int id, Point *positions, Vector *normals, unsigned int *colors, int size, int colours_divisor);
  GameApi::PinIn render_instanced_matrix(int id, Matrix *positions, Vector *normals, unsigned int *colors, int size, int colours_divisor);
