 ...
 std::vector<GameApiItem*> pointsapi_functions()
{
...
#endif
  vec.push_back(ApiItemF(&GameApi::EveryApi::matrices_api, &GameApi::MatricesApi::mn_matrix_array,
			 "ms_matrix_arr",
			 { "ev", "count", "move" },
			 { "EveryApi&", "int", "MN" },
			 { "ev", "100", "" },
  ...
  vec.push_back(ApiItemF(&GameApi::EveryApi::matrices_api, &GameApi::MatricesApi::mult_g_last_resize,
			 "ms_last_resize",
			 { "ev", "ms" },
			 { "EveryApi&", "MS" },
			 { "ev", "" },
			 "MS", "matrices_api", "mult_g_last_resize"));
  vec.push_back(ApiItemF(&GameApi::EveryApi::matrices_api, &GameApi::MatricesApi::random_time_seq,
			 ...
			 { "EveryApi&", "MS", "MS", "MS", "float", "float" },
			 { "ev", "", "", "", "30.0", "10.0" },
			 "MS", "matrices_api", "random_time_seq"));
